...
public class MovieBestPaging {
	...
	//디폴트 생성자
	public MovieBestPaging() { }
	
	//총 게시글 수를 입력하는 생성자
	public MovieBestPaging(int totalCount) {
	...
	public MovieBestPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MovieBestPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MovieBestPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(9);//화면에 보여질 게시글 수 기본설정
