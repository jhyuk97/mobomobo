		...
		, success : function(data) {
			...
			for(var i=0; i<data.writing.length; i++) {
				...
				if(data.writing[i].boardDiv == 3) {
					...
					html += "	<td class='longTitle'><a href='/mobo/movie/debate?nNo=" + data.writing[i].boardNo + "' class='titleColor'>" + data.writing[i].title + "</a></td>"					
				} else if (data.writing[i].boardDiv == 5) {
					html += "	<td class='longTitle'><a href='/mobo/book/debate?nNo=" + data.writing[i].boardNo + "' class='titleColor'>" + data.writing[i].title + "</a></td>"					
				}
		...
		, success : function(data) {
			...
			for(var i=0; i<data.comment.length; i++) {
				...
				if(data.comment[i].commentDiv == 1) {
					...
					html += "	<td class='longTitle'><a href='/mobo/movie/debate?nNo=" + data.comment[i].boardNo + "' class='titleColor'>" + data.comment[i].commentText + "</a></td>"
					html += "	<td>영화 토론</td>"
